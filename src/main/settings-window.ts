...
export function buildSettingsHtml(
  ...
  return `<!DOCTYPE html>
<!-- Pi Heao GUI V1.2.1 · made by HEAOZIE -->
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
<div class="toolbar">
  ...
  <span class="pi-ver" title="Pi Heao GUI V1.2.1 — made by HEAOZIE">V1.2.1</span>
...
<div class="brand" title="Pi Heao GUI V1.2.1 — made by HEAOZIE">made by HEAOZIE</div>
<script>
